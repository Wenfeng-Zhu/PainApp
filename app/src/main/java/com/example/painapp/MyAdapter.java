...
public class MyAdapter extends BaseAdapter {
    ...
    public MyAdapter(Context context,List<String> it,List<String> pa)
    {
        ...
        items = it;
        paths = pa;
        mIcon1 = BitmapFactory.decodeResource(context.getResources(),R.drawable.icons_black);
        mIcon2 = BitmapFactory.decodeResource(context.getResources(),R.drawable.icons_gray);
        mIcon3 = BitmapFactory.decodeResource(context.getResources(),R.drawable.icons_white);
